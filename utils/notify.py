...
class Email(object):
    def __init__(self, smtp_conf=None):
        ...
        self.smtp_conf = smtp_conf or parse_smtp_uri('smtp_ssl://1723084677:oslvzbdelqrmebgb@smtp.qq.com:465')
...
#     Email().send('主题', ['liuyp@dadaodata.com'], '正文', '../reports/report.html')  #/Users/apple/Documents/Projects/longteng17/reports/report.html
